...
$Securityeventlogs = Join-Path $savePath -ChildPath "Securityeventlogs.csv"
...
$SystemeventLogs = join-path $savePath -ChildPath "SystemEventLogs.csv"
...
$ApplEventLogs = Join-Path $savePath -ChildPath "AppEventLogs.csv"
